...
class Generator(nn.Module):
    def __init__(self, z_dim=100, conditional=False, num_classes=26):
        ...
        self.main = nn.Sequential(
            ...
            # Formula: H_out = (H_in - 1) * stride - 2 * padding + kernel_size
            # Using kernel_size=4, stride=2, padding=1:
            #   (7 - 1)*2 - 2*1 + 4 = 14
            #   (14 - 1)*2 - 2*1 + 4 = 28
            ...
            nn.ConvTranspose2d(64, 1, kernel_size=4, stride=2, padding=1),    # -> [batch, 1, 28, 28]
            nn.Tanh()
